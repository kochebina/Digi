...
#ifndef TestDigitizerInitializationModule_h
#define TestDigitizerInitializationModule_h 1
...
class TestDigitizerInitializationModule : public G4VDigitizerModule
{
public:
  
	TestDigitizerInitializationModule(G4String name);
...
private:
  ...
  //TestDigitizerMessenger* digiMessenger;
