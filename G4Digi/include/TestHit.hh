...
extern G4Allocator<TestHit> TestHitAllocator;

inline void* TestHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) TestHitAllocator.MallocSingle();
  return aHit;
}

inline void TestHit::operator delete(void *aHit)
{
	TestHitAllocator.FreeSingle((TestHit*) aHit);
}
#endif
