...
TestDigitizer::TestDigitizer(G4String name)
...
//create a messenger for this class
  digiMessenger = new TestDigitizerMessenger(this);
...
void TestDigitizer::Digitize()
{
	...
	G4cout<<"Digitizer::Digitize()"<<G4endl;
  DigitsCollection = new TestDigitsCollection ("TestDigitizer","DigitsCollection"); // to create the Digi Collection
  ...
  if(DCID<0)
    { 
      //	  DigiMan->List();
      DCID = DigiMan->GetDigiCollectionID("TestDigitizer/DigitsCollection");
    }
